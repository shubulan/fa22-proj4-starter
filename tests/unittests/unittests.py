...
class TestNeg(TestCase):
   def test_small_neg(self):
       # TODO: YOUR CODE HERE
       dp_mat, nc_mat = rand_dp_nc_matrix(2, 2, seed=0, low=-100, high=100)
       is_correct, speed_up = compute([[dp_mat], nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)

       dp_mat, nc_mat = rand_dp_nc_matrix(8, 8, seed=0, low=-100, high=100)
       is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)

       dp_mat, nc_mat = rand_dp_nc_matrix(32, 32, seed=0, low=-100, high=100)
       is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)

       dp_mat, nc_mat = rand_dp_nc_matrix(80, 80, seed=0, low=-100, high=100)
       is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)

       dp_mat, nc_mat = rand_dp_nc_matrix(128, 128, seed=0, low=-100, high=100)
       is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)

       dp_mat, nc_mat = rand_dp_nc_matrix(256, 256, seed=0, low=-100, high=100)
       is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)

       dp_mat, nc_mat = rand_dp_nc_matrix(300, 300, seed=0, low=-100, high=100)
       is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)
   ...
   def test_medium_neg(self):
       # TODO: YOUR CODE HERE
       dp_mat, nc_mat = rand_dp_nc_matrix(512, 512, seed=0, low=-100, high=100)
       is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)
   ...
   def test_large_neg(self):
       # TODO: YOUR CODE HERE
       dp_mat, nc_mat = rand_dp_nc_matrix(2000, 2000, seed=0, low=-100, high=100)
       is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)
...
class TestPow(TestCase):
    ...
    def test_medium_pow(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(200, 200, seed=0, low=-100, high=100)
    ...
    def test_large_pow(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(1000, 1000, seed=0, low=-100, high=100)
...
if __name__ == '__main__':
    #suit = unittest.TestLoader().loadTestsFromTestCase(TestMul)
    suit = unittest.TestLoader().loadTestsFromTestCase(TestNeg)
    #suit = unittest.TestLoader().loadTestsFromTestCase(TestPow)
